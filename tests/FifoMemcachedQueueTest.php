...
use Nia\Collection\Queue\Memcached\FifoMemcachedQueue;

/**
 * Unit test for \Nia\Collection\Queue\Memcached\FifoMemcachedQueue.
 */
class FifoMemcachedQueueTest extends PHPUnit_Framework_TestCase
{

    /**
     * @covers \Nia\Collection\Queue\Memcached\FifoMemcachedQueue
     */
    public function testQueue()
    {
        ...
        $queue = new FifoMemcachedQueue($memcached, 'test-fifo-queue');
